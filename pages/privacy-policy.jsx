...
const PrivacyPolicyPage = () => {
  return (
    <main className="w-full max-w-5xl mx-auto px-3">
      <Helmet>
        <meta charSet="utf-8" />
        <title>Privacy Policy - TTDL</title>
        <link
          rel="canonical"
          href="https://ttdl-six.vercel.app/privacy-policy"
        />
      ...
      <div className="py-6 sm:py-10 w-full h-full min-h-screen">
        ...
        <article className="prose max-w-none w-full prose-slate prose-li:list-disc">
          <p>
            At i-Gram.io, accessible from{" "}
            <Link href="/">https://www.ttdl.app/</Link>, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by i-Gram.io and how we use it.
          </p>
          ...
          <p>
            ...
            that they shared and/or collect in i-Gram.io. This policy is not
          ...
          <p>
            i-Gram.io follows a standard procedure of using log files. These
          ...
          <p>
            Like any other website, i-Gram.io uses "cookies". These cookies are
          ...
          <p>
            ...
            advertising partners of i-Gram.io.
          </p>

          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on i-Gram.io, which
          ...
          <p>
            Note that i-Gram.io has no access to or control over these cookies
          ...
          <p>
            i-Gram.io's Privacy Policy does not apply to other advertisers or
          ...
          <p>
            i-Gram.io does not knowingly collect any Personal Identifiable
